...
| REPOSITORY_GOODCHECK | oxsecurity/megalinter-only-repository_goodcheck:beta | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/oxsecurity/megalinter-only-repository_goodcheck/beta)  |
...
| SPELL_MISSPELL | oxsecurity/megalinter-only-spell_misspell:beta | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/oxsecurity/megalinter-only-spell_misspell/beta)  |
...
| TERRAFORM_KICS | oxsecurity/megalinter-only-terraform_kics:beta | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/oxsecurity/megalinter-only-terraform_kics/beta)  |
